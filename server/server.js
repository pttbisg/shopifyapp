  ...
  server.use(
    createShopifyAuth({
      async afterAuth(ctx) {
        ...
        //await subscribeOrdersWebhook(shop, accessToken);
        const order = new Order(shop, accessToken);
        await order.registerOrderCreateHook();
        await order.registerOrderUpdateHook();
